...
Revision ID: 14ce86041775
Revises: 
Create Date: 2024-04-06 10:49:56.206185
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['completed_by_id'], ['plumbers.id'], name='fk_jobs_completed_by'),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['plumbers.id'], ),
